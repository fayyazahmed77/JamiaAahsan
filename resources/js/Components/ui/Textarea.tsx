    ...
    return (
        <div className="form-group flex flex-col gap-1.5 w-full">
            ...
            <textarea
                ...
                data-slot="textarea"
                className={cn(
                    "min-h-16 w-full rounded-lg border border-stone-200 dark:border-stone-850 bg-white dark:bg-stone-900 px-3 py-1.5 text-base transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-primary-500 focus-visible:ring-3 focus-visible:ring-primary-500/15 disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 md:text-sm dark:disabled:bg-input/80 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 shadow-sm",
                    className
                )}
                aria-invalid={!!error}
