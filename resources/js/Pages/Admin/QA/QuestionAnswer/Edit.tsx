...
export default function QAEdit({ question, topics }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/qa/questions/${question.id}`);
    };
    ...
    return (
        ...
        >
            <Head title="Edit Question - Admin" />
...
QAEdit.layout = (page: React.ReactNode) => <AdminLayout children={page} />;
